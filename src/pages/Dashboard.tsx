             ...
             <div className="flex flex-col gap-6 relative z-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-auto">
                   ...
                   <motion.div 
                     whileTap={{ scale: 0.98 }}
                     onClick={() => haptic(5)}
                     className="bg-black/30 backdrop-blur-sm rounded-2xl p-4 border border-white/5 cursor-pointer hover:bg-white/5 transition-colors"
                   >
                   ...
                   <motion.div 
                     whileTap={{ scale: 0.98 }}
                     onClick={() => haptic(5)}
                     className="bg-black/30 backdrop-blur-sm rounded-2xl p-4 border border-white/5 overflow-hidden flex flex-col justify-center cursor-pointer hover:bg-white/5 transition-colors"
                   >
                      <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-2">
                        ...
                        rawWeightHistory.map((item, idx) => (
                          <div key={idx} className="flex items-center justify-between px-4 py-3 bg-white/5 rounded-2xl border border-white/5">
                            ...
                            <Button 
                              variant="ghost" 
                              size="icon" 
                              onClick={() => { haptic(5); handleDeleteWeightRecord(item.date, item.id); }}
